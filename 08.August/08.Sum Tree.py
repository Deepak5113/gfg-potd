...
class Solution:
    def is_sum_tree(self, node):
        ...
        def check_sum_tree(node):
            ...
            is_current_sum_tree = is_left_sum_tree and is_right_sum_tree and (
                node.data == left_sum + right_sum)

            return node.data + left_sum + right_sum, is_current_sum_tree

        _, is_sum_tree_result = check_sum_tree(root)
